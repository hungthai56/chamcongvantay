...
class BCGisbn extends BCGean13 {
    const GS1_AUTO = 0;
    const GS1idquan978 = 1;
    const GS1idquan979 = 2;
     ...
     *  - GS1idquan978: Adds 978 before the code
     *  - GS1idquan979: Adds 979 before the code
     *
     * @param int $gs1
     */
    public function setGS1($gs1) {
        $gs1 = (int)$gs1;
        if ($gs1 !== self::GS1_AUTO && $gs1 !== self::GS1idquan978 && $gs1 !== self::GS1idquan979) {
            throw new BCGArgumentException('The GS1 argument must be BCGisbn::GS1_AUTO, BCGisbn::GS1idquan978, or BCGisbn::GS1idquan979', 'gs1');
        }
    ...
    protected function checkCorrectLength() {
        ...
        if ($c === 13) {
            ...
            if ($this->gs1 === self::GS1_AUTO || $this->gs1 === self::GS1idquan978) {
                $this->text = '978' . $this->text;
            } elseif ($this->gs1 === self::GS1idquan979) {
