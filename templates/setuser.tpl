...
<div class="nenbao" style="padding: 10px;">
    ...
    <form name="frmProduct1" method="post">
        <div class="container" style="max-width: 100%;">
            ...
            <div class="row"
                ...
                <div>
                    <a class="help-a" style="background: green;" href="default.php?act=setuser&id=-1">Thêm
                        Mới</a>
                    <a class="help-a" style="background: red;" href="default.php?act=setuser">Đóng
                        Lại</a>
                </div>
                <div>
            ...
            <tr bgcolor="{color}">
                ...
                <td align="center">
                    <label for="sele<%=j%>" style="Font-Weight:Normal;Color:Black;cursor:hand">
                        <a href="default.php?act=setuser&id={ID}"><i class="fa-solid fa-pen-to-square"
                                style="color: green;"></i></a></label>
                </td>

                <td align="center">
                    <a onclick='return ask()'
                        href="default.php?act=setuser&Del={ID}&ip={linkcc}&port={cong}&ch={IDcuahang}&uid={uid}"><i
    ...
    <form name="frmkho" id="frmkho" method="post">
        <fieldset class="nencon" id="khachhang">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="nhanviendl" id="nhanviendl" class="macuahang" size="16"
                            value="{nhanviendl}" />
                        <input type="hidden" name="manvdl" id="manvdl" class="macuahang" size="16"
                            value="{manvdl}" />
                    </td>
                    <td>
            ...
            <div style="padding-left:105px;padding-bottom:8px">
                ...
                <a class="help-a" style="background: #c0392b;" href="?act=setuser" type="button">Quay
                    Lại</a>
            </div>
        </fieldset>
    </form>
    ...
    <script language="JavaScript">
        ...
        location.replace("default.php?act=setuser");
    </script>
    <!-- END: block_cusupdate -->
    ...
    <script language="javascript">
        ...
        function changenhanvien() {
            ...
            loadtrang('Name', "setuserhienthi", poststr, "");
